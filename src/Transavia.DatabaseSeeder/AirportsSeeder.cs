...
namespace Transavia.DatabaseSeeder
{
    ...
    {
        private readonly HttpFeedDataProvider<AirportData> _airportsProvider;
        private readonly TransaviaDbContext _ctx;

        private readonly Dictionary<string, string> _continentCodeToNameMap = new Dictionary<string, string>
        {
            { "AF", "Africa" },
            { "AN", "Antarctica" },
            { "AS", "Asia" },
